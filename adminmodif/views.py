...
def assign_group(request):
    ...
    if serializer.is_valid():
        ...
        GroupMembership.objects.create(
            user=user, group=group, start_date=start_date, end_date=end_date
        )
        ...
        return JsonResponse(
            {"status": "Group assigned successfully.", "active_groups": active_groups_info}
        )
    else:
...
def list_employee_groups(request, employee_id):
    ...
    return JsonResponse({"employee_id": employee_id, "groups": groups_info})
