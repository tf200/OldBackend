...
from adminmodif.models import Group, GroupMembership
        ...
        with transaction.atomic():
            ...
            if user_created:
                ...
                GroupMembership.objects.create(
                    user=user, group=client_group, start_date=None, end_date=None
                )
            else:
            ...
            for updated_contract in updated_details:
                for contract in invoice.invoice_details:
                    if contract["contract"] == updated_contract["contract"]:
                        contract["pre_vat_total"] = updated_contract.get(
                            "pre_vat_total", contract["pre_vat_total"]
                        )

                        contract["vat_rate"] = updated_contract.get(
