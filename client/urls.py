...
urlpatterns = [
    ...
    path(
        "diagnosis_retreive/<int:pk>/", DiagnosisRetrieveView.as_view(), name="diagnosis_retrieve"
    ),
    ...
    path(
        "emergency_retreive/<int:pk>/",
        ClientEmergencyContactRetrieveView.as_view(),
        name="diagnosis_retrieve",
    ),
    path(
        "emergency_list/<int:client>/",
        ClientEmergencyContactListView.as_view(),
        name="diagnosis_list",
    ),
    path(
        "emergency_update/<int:pk>/",
        ClientEmergencyContactUpdateView.as_view(),
        name="diagnosis_update",
    ),
    path(
        "emergency_delete/<int:pk>/",
        ClientEmergencyContactDeleteView.as_view(),
    ...
    path(
        "medication_retreive/<int:pk>/",
        ClientMedicationRetrieveView.as_view(),
        name="medication_retrieve",
    ),
    path(
        "medication_list/<int:client>/", ClientMedicationListView.as_view(), name="medication_list"
    ),
    path(
        "medication_update/<int:pk>/",
        ClientMedicationUpdateView.as_view(),
        name="medication_update",
    ),
    path(
        "medication_delete/<int:pk>/",
        ClientMedicationDeleteView.as_view(),
        name="medication_delete",
    ),
    path("allergy_create/", ClientAllergyCreateView.as_view(), name="allergy_create"),
    path(
        "allergy_retrieve/<int:pk>/", ClientAllergyRetrieveView.as_view(), name="allergy_retrieve"
    ),
    ...
    path(
        "invoice_contracts/<int:invoice_id>/",
        InvoiceContractListView.as_view(),
        name="invoice-contract-list",
    ),
